...
import com.sicepat.xrayapp.root.RootProxyManager.TABLE
import com.sicepat.xrayapp.root.RootProxyManager.TUN
import com.sicepat.xrayapp.root.RootProxyManager.teardown
...
object RootProxyManager {
     ...
     */
    suspend fun startClientSharing(context: Context): Boolean {
        teardown(context)
    ...
    private suspend fun teardown(context: Context) {
