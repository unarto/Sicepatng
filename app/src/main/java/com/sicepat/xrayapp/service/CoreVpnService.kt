...
import com.sicepat.xrayapp.AppConfig.LOOPBACK
import com.sicepat.xrayapp.BuildConfig
import com.sicepat.xrayapp.contracts.ServiceControl
import com.sicepat.xrayapp.contracts.Tun2SocksControl
...
import com.sicepat.xrayapp.root.RootLanSharing
...
//        saveVpnNetworkInfo(configName, info)
        ...
        if (isForced) {
            ...
            // Replace sleep with busy wait or handle differently?
            // This is in onDestroy so we can't easily launch a coroutine to wait and then close interface if we are returning immediately.
            try {
                Thread.sleep(100)
