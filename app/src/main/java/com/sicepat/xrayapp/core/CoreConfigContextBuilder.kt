...
object CoreConfigContextBuilder {
     ...
     */
    suspend fun build(context: Context, guid: String): CoreConfigContext? = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        ...
        if (config.configType == EConfigType.CUSTOM) {
            return@withContext CoreConfigContext(context = context, guid = guid, isCustom = true)
        }
        ...
        return@withContext CoreConfigContext(
            context = context,
            guid = guid,
