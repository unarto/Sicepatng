...
import com.sicepat.xrayapp.core.CoreConfigManager
import com.sicepat.xrayapp.dto.SubscriptionUpdateResult
import com.sicepat.xrayapp.dto.UrlContentRequest
import com.sicepat.xrayapp.dto.entities.ProfileItem
import com.sicepat.xrayapp.dto.entities.SubscriptionCache
...
import com.sicepat.xrayapp.fmt.CustomFmt
import com.sicepat.xrayapp.fmt.Hysteria2Fmt
import com.sicepat.xrayapp.fmt.ShadowsocksFmt
import com.sicepat.xrayapp.fmt.SocksFmt
import com.sicepat.xrayapp.fmt.TrojanFmt
import com.sicepat.xrayapp.fmt.VlessFmt
import com.sicepat.xrayapp.fmt.VmessFmt
import com.sicepat.xrayapp.fmt.WireguardFmt
...
object AngConfigManager {
     ...
     */
    suspend fun importBatchConfig(server: String?, subid: String, append: Boolean): Pair<Int, Int> = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        ...
        return@withContext count to countSub
    }
     ...
     */
    suspend fun updateConfigViaSubAll(): SubscriptionUpdateResult = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
     ...
     */
    suspend fun updateConfigViaSub(it: SubscriptionCache): SubscriptionUpdateResult = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        try {
            // Check if disabled
            if (!it.subscription.enabled) {
                return@withContext SubscriptionUpdateResult(skipCount = 1)
            }
            ...
            if (!Utils.isValidUrl(url)) {
                return@withContext SubscriptionUpdateResult(failureCount = 1)
            }
