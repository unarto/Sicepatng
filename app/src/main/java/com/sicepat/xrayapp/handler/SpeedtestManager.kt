...
import com.sicepat.xrayapp.dto.IPAPIInfo
...
object SpeedtestManager {
     ...
     */
    suspend fun socketConnectTime(url: String, port: Int, timeoutMs: Int = 1500): Long = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
    ...
    suspend fun getRemoteIPInfo(): String? = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        ...
        if (httpPort == 0) return@withContext null
        ...
        val ipInfo = JsonUtil.fromJsonSafe(content, IPAPIInfo::class.java) ?: return@withContext null
        ...
        return@withContext "(${country ?: "unknown"}) ${ip ?: "unknown"}"
    }
}
