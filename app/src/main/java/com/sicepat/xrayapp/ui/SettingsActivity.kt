...
import com.sicepat.xrayapp.AppConfig.VPN
...
import com.sicepat.xrayapp.helper.MmkvPreferenceDataStore
...
class SettingsActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNav?.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.nav_dashboard, R.id.nav_proxies, R.id.nav_profiles -> {
                    finish()
                    true
                }
                else -> true
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(bundle: Bundle?, s: String?) {
            ...
            findPreference<androidx.preference.Preference>("pref_theme")?.setOnPreferenceClickListener {
                startActivity(android.content.Intent(requireActivity(), ThemeActivity::class.java))
                true
            }
            findPreference<androidx.preference.Preference>("pref_backup_restore")?.setOnPreferenceClickListener {
                startActivity(android.content.Intent(requireActivity(), BackupActivity::class.java))
                true
            }
            findPreference<androidx.preference.Preference>("pref_per_app_proxy")?.setOnPreferenceClickListener {
                startActivity(android.content.Intent(requireActivity(), PerAppProxyActivity::class.java))
                true
            }
            findPreference<androidx.preference.Preference>("pref_routing_setting")?.setOnPreferenceClickListener {
                startActivity(android.content.Intent(requireActivity(), RoutingSettingActivity::class.java))
                true
            }
            findPreference<androidx.preference.Preference>("pref_sub_setting")?.setOnPreferenceClickListener {
                startActivity(android.content.Intent(requireActivity(), SubSettingActivity::class.java))
                true
            }
            findPreference<androidx.preference.Preference>("pref_logcat")?.setOnPreferenceClickListener {
                startActivity(android.content.Intent(requireActivity(), LogcatActivity::class.java))
                true
            }
            findPreference<androidx.preference.Preference>("pref_check_update")?.setOnPreferenceClickListener {
                startActivity(android.content.Intent(requireActivity(), CheckUpdateActivity::class.java))
                true
            }
