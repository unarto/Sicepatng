...
object AppConfig {
    ...
    const val PREF_LIST_LAYOUT = "pref_list_layout"
    const val PREF_LIST_SIZE = "pref_list_size"
    const val PREF_LANGUAGE = "pref_language"
    const val PREF_UI_MODE_NIGHT = "pref_ui_mode_night"
    const val PREF_THEME_SCHEME = "pref_theme_scheme"
    const val PREF_THEME_COLOR_CUSTOM = "pref_theme_color_custom"
    const val PREF_THEME_COLOR_SEED = "pref_theme_color_seed"
    const val PREF_THEME_PURE_BLACK = "pref_theme_pure_black"
    const val PREF_THEME_TEXT_SCALING_ENABLED = "pref_theme_text_scaling_enabled"
    const val PREF_THEME_TEXT_SCALING_VALUE = "pref_theme_text_scaling_value"
    ...
    const val RAY_NG_CHANNEL_NAME = "SiCepat Background Service"
